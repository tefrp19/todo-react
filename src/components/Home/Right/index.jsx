...
export default function Right(props) {
    ...
    if (!Number.isInteger(taskDetailId)) {
        taskDetail = {
            check: 0,
            name: '',
            important: 0,
        ...
        taskDetail = tasks.find(task => task.id === taskDetailId)
    }
    ...
    return <div className={`task-detail ${view.showRightColumn ? 'rightColumn-entered' : 'rightColumn-exited'}`}>
